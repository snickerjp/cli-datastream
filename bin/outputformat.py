# DataStream CLI Output Formatting Module
"""
Output formatting utilities for Akamai DataStream CLI.
...
def formatOutputStreamDetail(streamDetail, output_type):
    ...
    if output_type == "text":
        ...
        print(
            "Upload Frequency(in secs):",
            streamDetail["config"]["frequency"]["timeInSec"],
        )
